...
export default function dateFormatter({ 
  ...
  if (formatStyle) {
    return new Intl.DateTimeFormat(locale, { 
      dateStyle: formatStyle as any, // Type assertion needed for TypeScript
...
export const dateFormatters = {
   ...
   * // Output: "April 15, 2023"
   */
  longDate: (date: string | Date) => dateFormatter({
    date,
    month: 'long',
    day: 'numeric',
    year: 'numeric'
   ...
   * // Output: "4/15/2023"
   */
  shortDate: (date: string | Date) => dateFormatter({
    date,
    month: 'numeric',
    day: 'numeric',
    year: 'numeric'
   ...
   * // Output: "Saturday, April 15, 2023"
   */
  fullDate: (date: string | Date) => dateFormatter({
    date,
    weekday: 'long',
    month: 'long',
    day: 'numeric',
   ...
   * // Output: "Apr 15, 2023"
   */
  mediumDate: (date: string | Date) => dateFormatter({
    date,
    month: 'short',
    day: 'numeric',
    year: 'numeric'
   ...
   * // Output: "4/2023"
   */
  monthYear: (date: string | Date) => dateFormatter({
    date,
    month: 'numeric',
    year: 'numeric'
  }),
   ...
   * // Output: "April 2023"
   */
  longMonthYear: (date: string | Date) => dateFormatter({
    date,
    month: 'long',
    year: 'numeric'
  }),
   ...
   */
  utcDate: (date: string | Date) => dateFormatter({
    date,
    month: 'long',
    day: 'numeric',
    year: 'numeric',
   ...
   * // Output: "April 15, 2023, 2:30 PM GMT+2"
   */
  dateWithTimeZone: (date: string | Date) => dateFormatter({
    date,
    month: 'long',
    day: 'numeric',
    year: 'numeric',
   ...
   */
  inTimezone: (date: string | Date, tz: string) => dateFormatter({
    date,
    month: 'long',
    day: 'numeric',
    year: 'numeric',
   ...
   */
  ultimateDate: (date: string | Date) => dateFormatter({
    date,
    weekday: 'long',
    era: 'long',
    year: 'numeric',
   ...
   * // Output: "Saturday, April 15, 2023"
   */
  fullStyle: (date: string | Date) => dateFormatter({
    date,
    formatStyle: 'full'
  }),
   ...
   * // Output: "April 15, 2023"
   */
  longStyle: (date: string | Date) => dateFormatter({
    date,
    formatStyle: 'long'
  }),
   ...
   * // Output: "Apr 15, 2023"
   */
  mediumStyle: (date: string | Date) => dateFormatter({
    date,
    formatStyle: 'medium'
  }),
   ...
   * // Output: "4/15/23"
   */
  shortStyle: (date: string | Date) => dateFormatter({
    date,
    formatStyle: 'short'
  })
};