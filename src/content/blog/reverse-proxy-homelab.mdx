...
*Caddy sits as the single entry point on port 443, handling TLS termination and routing requests to backend services by domain name — each service stays on its own internal port, never exposed directly.*
