...
![A simplified tailnet mesh diagram showing encrypted peer-to-peer links](/images/blog/tailscale-explained/tailnet-mesh.svg)
*Every device in your tailnet forms direct WireGuard tunnels — no central server routes your traffic.*
...
*Tailscale's control plane coordinates (keys, ACLs, discovery) while your actual traffic flows directly between devices on the data plane.*
