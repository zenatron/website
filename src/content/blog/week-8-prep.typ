...
For Project 3, I will be creating a regression model in order to predict song popularity based on musical parameters, such as tempo, energy, loudness, time signature, and other features. I will use the #link("https://www.kaggle.com/datasets/amitanshjoshi/spotify-1million-tracks")[Spotify 1 Million Tracks Dataset from Kaggle], which contains a large set of over 1,000,000 tracks from Spotify, along with 19 features. The dataset appears to be mostly clean and ready for modeling; however, some preprocessing still may be necessary.

= Key Questions

From this Project, I aim to answer the following questions:

+ Can we accurately predict the popularity of a song using solely its musical parameters?
+ Can we accurately predict the popularity of a song prior to its public release?
+ Which features are most important to predicting song popularity, irregardless of artist?
