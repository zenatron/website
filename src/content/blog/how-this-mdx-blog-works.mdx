---
title: "How This Blog Renders MDX"
date: "2025-02-21"
readingTime: "22min"
excerpt: "The Astro and MDX pipeline behind this site: what runs at build time, what ships to the browser, and why that is almost nothing."
...
<Diagram src="/images/blog/how-this-mdx-blog-works/mdx-pipeline.svg" alt="MDX pipeline diagram" />
<Diagram src="/images/blog/how-this-mdx-blog-works/compile-flow.svg" alt="MDX compilation flow diagram" />
...
## The remark/rehype plugin pipeline

MDX doesn't just parse Markdown — it runs your content through a **[unified](https://unifiedjs.com/)** pipeline with two processing stages:
