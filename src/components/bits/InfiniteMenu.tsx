...
void main() {
    ...
    // Get the center position of the square in world space
    vec3 centerPos = (uWorldMatrix * aInstanceMatrix * vec4(0., 0., 0., 1.)).xyz;
    float radius = length(centerPos.xyz);
    
    // Simply project the position onto the sphere
...
void main() {
    ...
    float containerAspect = 1.0; // Square container
    
    // Map UVs directly without rotation or cover scaling
    vec2 st = vUvs;
  ...
  private initTexture(): void {
    ...
    Promise.all(
      ...
      if (failedUrls.length > 0) {
        console.log('Failed to load images:', failedUrls);
      }
