...
const SkeletonCard = () => (
  <div className="h-[200px] w-full rounded-lg bg-white/5 border border-white/5 p-4 animate-pulse">
    ...
    <div className="h-4 w-1/2 rounded bg-gray-300/10 mb-4"></div>{" "}
    {/* Date/Meta */}
    <div className="h-4 w-full rounded bg-gray-300/10 mb-2"></div>{" "}
    {/* Excerpt line 1 */}
    <div className="h-4 w-5/6 rounded bg-gray-300/10 mb-4"></div>{" "}
    {/* Excerpt line 2 */}
...
const ClientSkeletonLoader: React.FC<ClientSkeletonLoaderProps> = ({
  itemCount = 6,
  layout = "list",
}) => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8 animate-pulse">
        <div className="h-10 w-48 bg-gray-300/10 rounded-lg"></div>{" "}
        {/* Sort controls */}
        <div className="h-10 w-full md:w-1/2 bg-gray-300/10 rounded-lg"></div>{" "}
        {/* Search bar */}
      ...
      {/* Items Skeleton */}
      <div
        className={`animate-pulse ${layout === "list" ? "space-y-6" : "grid grid-cols-1 md:grid-cols-2 gap-6"}`}
      >
