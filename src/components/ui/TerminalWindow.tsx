...
const THEMES: Record<string, Record<string, string>> = {
  "atom-one-dark": {
    ...
    cyan: "#56b6c2", green: "#98c379", yellow: "#e5c07b", orange: "#d19a66",
    red: "#e06c75", comment: "#5c6370", white: "#e6e6e6", gutter: "#3e4451",
    cursor: "#528bff",
  },
  dracula: {
    bg: "#282a36", fg: "#f8f8f2", purple: "#bd93f9", blue: "#8be9fd",
    cyan: "#8be9fd", green: "#50fa7b", yellow: "#f1fa8c", orange: "#ffb86c",
    red: "#ff5555", comment: "#6272a4", white: "#f8f8f2", gutter: "#44475a",
    cursor: "#f8f8f2",
  },
  gruvbox: {
    bg: "#282828", fg: "#ebdbb2", purple: "#d3869b", blue: "#83a598",
    cyan: "#8ec07c", green: "#b8bb26", yellow: "#fabd2f", orange: "#fe8019",
    red: "#fb4934", comment: "#928374", white: "#fbf1c7", gutter: "#3c3836",
    cursor: "#ebdbb2",
  },
  nord: {
    bg: "#2e3440", fg: "#d8dee9", purple: "#b48ead", blue: "#81a1c1",
    cyan: "#88c0d0", green: "#a3be8c", yellow: "#ebcb8b", orange: "#d08770",
    red: "#bf616a", comment: "#4c566a", white: "#eceff4", gutter: "#3b4252",
    cursor: "#d8dee9",
  },
  catppuccin: {
    bg: "#1e1e2e", fg: "#cdd6f4", purple: "#cba6f7", blue: "#89b4fa",
    cyan: "#94e2d5", green: "#a6e3a1", yellow: "#f9e2af", orange: "#fab387",
    red: "#f38ba8", comment: "#585b70", white: "#cdd6f4", gutter: "#313244",
    cursor: "#f5e0dc",
  },
  "high-contrast": {
    bg: "#0a0a0a", fg: "#f5f5f5", purple: "#e78bf9", blue: "#6cb6ff",
    cyan: "#39d2e0", green: "#56d364", yellow: "#e3b341", orange: "#f0883e",
    red: "#f47067", comment: "#9e9e9e", white: "#ffffff", gutter: "#3d3d3d",
    cursor: "#ffffff",
  },
  "tokyo-night": {
    bg: "#1a1b26", fg: "#a9b1d6", purple: "#bb9af7", blue: "#7aa2f7",
    cyan: "#7dcfff", green: "#9ece6a", yellow: "#e0af68", orange: "#ff9e64",
    red: "#f7768e", comment: "#565f89", white: "#c0caf5", gutter: "#292e42",
    cursor: "#c0caf5",
  },
  "solarized-dark": {
    bg: "#002b36", fg: "#839496", purple: "#d33682", blue: "#268bd2",
    cyan: "#2aa198", green: "#859900", yellow: "#b58900", orange: "#cb4b16",
    red: "#dc322f", comment: "#586e75", white: "#fdf6e3", gutter: "#073642",
    cursor: "#839496",
  },
  monokai: {
    bg: "#272822", fg: "#f8f8f2", purple: "#ae81ff", blue: "#66d9ef",
    cyan: "#66d9ef", green: "#a6e22e", yellow: "#e6db74", orange: "#fd971f",
    red: "#f92672", comment: "#75715e", white: "#f8f8f0", gutter: "#3e3d32",
    cursor: "#f8f8f0",
  },
  "i-hate-colors": {
    bg: "#1a1a1a", fg: "#d4d4d4", purple: "#b0b0b0", blue: "#b0b0b0",
    cyan: "#b0b0b0", green: "#b0b0b0", yellow: "#b0b0b0", orange: "#b0b0b0",
    red: "#b0b0b0", comment: "#686868", white: "#e8e8e8", gutter: "#333333",
    cursor: "#d4d4d4",
  },
};
